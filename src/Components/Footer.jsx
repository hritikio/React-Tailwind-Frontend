import {FaDribbbleSquare,FaGithubSquare,FaFacebookSquare,FaInstagram,FaTwitterSquare} from 'react-icons/fa';
      ...
      <div className="max-w[1240px] mx-auto py-16 px-8 grid lg:grid-cols-3 gap-8 text-gray-300 ">
        <div>
          ...
          <p className="py-4">
            ...
            facere excepturi. Officia deleniti quae cupiditate, excepturi
            voluptatum qui in sint?
          </p>
